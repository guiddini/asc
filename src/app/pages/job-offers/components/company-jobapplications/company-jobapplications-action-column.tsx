...
import AcceptJobApplicationModal from "./accept-job-application-modal";

const CompanyJobapplicationsActionColumn = (props: CompanyJobApplication) => {
...
export default CompanyJobapplicationsActionColumn;
